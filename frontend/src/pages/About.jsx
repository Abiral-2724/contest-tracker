      ...
      <main className="flex-grow">
        <div className="container mx-auto px-4 py-12 max-w-4xl">
          ...
          <div className="grid gap-8 mt-12">
                ...
                <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
                  <div className="flex flex-col space-y-1.5 p-6 pb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="font-semibold tracking-tight text-lg">Contest Calendar</div>
                    </div>
                  </div>
                ...
                <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
                  <div className="flex flex-col space-y-1.5 p-6 pb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="font-semibold tracking-tight text-lg">Notifications</div>
                    </div>
                  </div>
                  <div className="p-6 pt-0">
                    <div className="text-sm text-muted-foreground">
                ...
                <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
                  <div className="flex flex-col space-y-1.5 p-6 pb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="font-semibold tracking-tight text-lg">Bookmarking</div>
                    </div>
                  </div>
                  <div className="p-6 pt-0">
                    <div className="text-sm text-muted-foreground">
                ...
                <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
                  <div className="flex flex-col space-y-1.5 p-6 pb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="font-semibold tracking-tight text-lg">Solution Links</div>
                    </div>
                  </div>
                  <div className="p-6 pt-0">
                    <div className="text-sm text-muted-foreground">
                ...
                <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
                  <div className="flex flex-col space-y-1.5 p-6 pb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="font-semibold tracking-tight text-lg">Search & Filter</div>
                    </div>
                  </div>
                  <div className="p-6 pt-0">
                    <div className="text-sm text-muted-foreground">
                ...
                <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
                  <div className="flex flex-col space-y-1.5 p-6 pb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="font-semibold tracking-tight text-lg">Command Menu</div>
                    </div>
                  </div>
                  <div className="p-6 pt-0">
                    <div className="text-sm text-muted-foreground">
            ...
            <section className="mt-12">
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <div className="p-4 rounded-lg border flex items-center justify-center h-24 font-medium text-lg" style={{ borderColor: '#1890ff', color: '#1890ff' }}>
                  Codeforces
                </div>
                <div className="p-4 rounded-lg border flex items-center justify-center h-24 font-medium text-lg" style={{ borderColor: '#ffa116', color: '#ffa116' }}>
                  LeetCode
                </div>
                <div className="p-4 rounded-lg border flex items-center justify-center h-24 font-medium text-lg" style={{ borderColor: '#6e56cf', color: '#6e56cf' }}>
                  AtCoder
                </div>
                <div className="p-4 rounded-lg border flex items-center justify-center h-24 font-medium text-lg" style={{ borderColor: '#5cb85c', color: '#5cb85c' }}>
                  CodeChef
                </div>
              </div>
            </section>
          ...
          <div className="mt-16 text-center">
            ...
            <a href="/">
              <Button className="bg-primary text-primary-foreground hover:bg-primary/90 h-11 rounded-md px-8 mt-2">
